...
/**
 * @page nbiassemblehelmholtz Assembling matrices for Helmholtz problems
 *
 * @c nbi-assemble-helmholtz takes an input geometry, generated by @c
 * nbi-surface (@ref nbisurface) and outputs the system matrices
 * required to solve the boundary integral problem using @c
 * nbi-solve-helmholtz (@ref nbisolvehelmholtz) 
 *
 * @verbatim
 nbi-assemble-helmholtz -h
 @endverbatim
 *
...

{
  ...
  fprintf(f,
	  ...
	  "  -g [input geometry file name]\n"
	  "  -k # wavenumber\n"
	  "  -m [output matrix file name]\n"
...

{
  ...
  nqu = 25 ;
  eta = 1.25 ; dmax = 8 ; tol = 1e-12 ; N = 8 ; nqa = 25 ;
  nnmax = 8192 ; 
