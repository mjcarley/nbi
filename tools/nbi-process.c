 ...
 * for visualisation or further analysis. It takes an NBI surface file
 * and, optionally, a surface data file and generates a .msh file
 * which can be read by GMSH for visualisation. 
 *
 * @verbatim
 nbi-process -h
 @endverbatim
 ...
 * data. This is useful for visualising a surface to check it looks
