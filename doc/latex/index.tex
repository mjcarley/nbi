...
This generates a spherical surface as a twice refined icosahedron; assembles the problem matrices for a wavenumber $k=3$; solves for a boundary condition given in the file point.\+bc

More details are available on how to use the NBI executables to set up and solve problems, and to process the results
