...
# Test to check if the installed BLAS is ATLAS because it has a strange
# naming scheme for catlas_?axpby
if test x"$acx_blas_atlas" = xyes; then
        AC_DEFINE(HAVE_ATLAS_BLAS,1,[Define if you have an ATLAS BLAS library.])
fi
